...
<tr>
<td colspan="3"><a href="generate.php">Add New Flavours</a></td>
</tr>
<tr>
<th align="center">Select</th>
<th align="center">Flavour</th>
<th align="center">Cost Per Gram</th>
<th align="center">Average Production</th>
</tr>
<?php
 $res = $con->query("SELECT * FROM gelatoflavors");
 $count = $res->num_rows;
 ...
 if($count > 0)
 {
  while($row=$res->fetch_array())
  {
   ...
   <td><?php echo $row['costpergm']; ?></td>
   <td><?php echo $row['avgprod']; ?></td>
   </tr>
   <?php
  } 
 }
